...
<html lang="en">
	<head>
		...
		<title>Courses | Dr. Ambedkar's Electrohomoeopathy Medical Institute | Developed By Rayedox Technologies</title>
		...
		<div class="site-content">
			...
			<div class="page-head" data-bg-image="images/slider-1.jpg">
				<div class="container">
					...
					<small>Have a look over the various courses provided by us.</small>
				</div>
			</div>
						...
						<div class="project-list">
							<div class="project">
								<div class="project-content">
									<h3 class="project-title">OT</h3>
								</div>
							</div>
							<div class="project">
								<div class="project-content">
									<h3 class="project-title">BEMS</h3>
								</div>
							</div>
							<div class="project">
								<div class="project-content">
									<h3 class="project-title">Diploma in Medical Lab Technology (DMLT)</h3>
								</div>
							</div>
							<div class="project">
								<div class="project-content">
									<h3 class="project-title">Electrocardiography (ECG)</h3>
								</div>
							</div>
							<div class="project">
								<div class="project-content">
									<h3 class="project-title">DEMS (Diploma)</h3>
								</div>
							</div>
